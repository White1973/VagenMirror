#!/usr/bin/env bash
# FrozenLake RLCER using the trained Qwen2.5-VL LoRA verifier over HTTP.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-frozenlake_rlcer_n8_external_trained_verifier_seed_${TRAINING_SEED}}"
export CORR_SCHEMA_VERSION="${CORR_SCHEMA_VERSION:-frozenlake_rlcer_n8_external_trained_verifier_v1}"
