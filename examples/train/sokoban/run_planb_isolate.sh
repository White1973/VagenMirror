...
EXPERIMENT_NAME="ppo_qwen25vl3b_planb_isolate_0725"
...
REF_MODEL_PATH=/personal/jiayu2026/models/vagen_sokoban0424
mkdir -p ${EXPERIMENT_DIR}

RAY_PORT=0 PYTHONUNBUFFERED=1 CUDA_VISIBLE_DEVICES=2,3 /opt/conda/envs/vagen/bin/python3 -m vagen.main_ppo \
